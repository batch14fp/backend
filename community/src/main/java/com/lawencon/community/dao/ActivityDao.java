...
public class ActivityDao extends BaseMasterDao<Activity> {
	...
	public List<Activity> getAll() {
		...
		sqlQuery.append(
				"SELECT a.id,a.category_id, c.category_code, c.category_name,at.id, at.type_code,at.activity_name,a.file_id,a.user_id,a.price,");
		sqlQuery.append("a.title,a.provider,a.activity_location, a.start_date,a.end_date,");
		sqlQuery.append("a.ver,a.is_active ");
		...
		try {
			if (result != null) {
				for (final Object objs : result) {
					...
					activity.setVersion(Integer.valueOf(obj[15].toString()));
					activity.setIsActive(Boolean.valueOf(obj[16].toString()));
