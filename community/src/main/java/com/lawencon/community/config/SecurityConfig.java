...
public class SecurityConfig {
	...
	public List<RequestMatcher> matchers() {
		...
		matcher.add(new AntPathRequestMatcher("/activities/admin/report/**", HttpMethod.GET.name()));
		matcher.add(new AntPathRequestMatcher("/activities/member/report/**", HttpMethod.GET.name()));
		return matcher;
	}
